...
```{r, code_folding=F}
df_classification <- read_rds("data/race_classification.rds") 
...
```{r, code_folding=F}
wf_final <- wf %>% 
  finalize_workflow(select_best(results, "sens"))
```
...
final_fit %>% write_rds("data/final_fit.rds")
