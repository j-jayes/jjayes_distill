...
```{r, literacy-scatter, layout="l-body-outset", fig.width = 8, fig.height=6, fig.cap="Caption"}
...
#### Percentage of foriegn born individuals
...
```{r, birth-place-corr, layout="l-body-outset", fig.width = 8, fig.height=6, fig.cap="Birth places of residents"}
birth_place_shares %>% 
  group_by(town) %>% 
