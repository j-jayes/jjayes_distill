...
The definitive guide to `ggplot2`, [The ggplot2 Book](https://ggplot2-book.org/index.html) is a fantastic resource for novices and experts alike. It is easy to navigate and has helpful examples with code used to create each figure. (I love to consult the section on annotations as I never remember exactly how they work for some reason.)
